...
==syntax_highlight :html
  erb:
    ...
    <link rel="stylesheet" href="http://uom-design-system.s3.amazonaws.com/v0.4/uom.css">
    <script src="http://uom-design-system.s3.amazonaws.com/v0.4/uom.js"></script>
...
section
  p: em Please note that in the example above, <b class="red">v0.4</b> refers to a specific version of the design system and may not be the current version! Please refer to the homepage.
