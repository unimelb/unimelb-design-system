A basic example showing how to modify the height and width of the map container and zoom the map using a zoom value (a `data-zoom` value of `1` shows the whole Earth, a `data-zoom` value of `17` is default).
```html
